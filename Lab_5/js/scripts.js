...
header.innerText = "John Henrici's List of Countries";
...
p.innerHTML = "<br>Format: Country Name - Country Code";
content.insertBefore(p, olist);
const but = document.createElement("button");
but.innerText = "Randomize Country List";
but.onclick = clist;
content.insertBefore(but, p);
  ...
  function clist() {
    const countries = [
      ...
      for (let i = 0; i < 25; i++) {
          ...
          const randomItem = countries.splice(randomIndex, 1)[0];
          const li = document.createElement("li");
          li.innerHTML = countries[randomIndex].name + " - <strong>" + countries[randomIndex].code + "</strong>";
